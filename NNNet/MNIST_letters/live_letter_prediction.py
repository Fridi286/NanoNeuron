...
class LetterDrawer:
    def __init__(self, root):
        self.root = root
        root.title("Live Letter Predictor")
        ...
        self.ax.set_title("Letter Prediction Probabilities")
        self.ax.set_ylim([0, 1])
        self.ax.set_xticks(range(26))
        self.ax.set_xticklabels(LETTERS, fontsize=8)

        self.bars = self.ax.bar(range(26), [0]*26)
