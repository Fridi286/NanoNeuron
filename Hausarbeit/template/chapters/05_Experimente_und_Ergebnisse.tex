...
Die gezeigten Kennzahlen stammen aus den ausgewerteten Trainingsläufen und den dazugehörigen Analyseabbildungen. Dadurch sind die Aussagen in diesem Kapitel direkt anhand der visualisierten Ergebnisse nachvollziehbar.
...
Zusätzlich wurde die Trainingszeit pro Epoche ausgewertet (Abbildung~\ref{fig:training-time}).
...
Die Abbildungen~\ref{fig:best-model}, \ref{fig:best-by-category} und \ref{fig:training-time} fassen die Kernergebnisse der Auswertung zusammen.
